...
const Customize = (function(){
  function init(){
    ...
    document.getElementById('save').onclick = ()=>{
      ...
      ['dashboard','assignments','gpa','flashcards','essay','import','customize'].forEach(m=> st.modules[m] = document.getElementById('mod-'+m).checked);
    ...
    Store.profiles().forEach(id=>{
      ...
      del.onclick = ()=>{ if(confirm('Delete profile \"'+id+'\"?')){ Store.remove(id); location.reload(); } };
