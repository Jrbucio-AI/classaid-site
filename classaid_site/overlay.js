...
(function(){
  ...
  function ensure(){
    ...
    bar.style.cssText='position:fixed;right:16px;top:16px;background:#0d1311;border:1px solid #1b2622;color:#e8f2ed;padding:8px 10px;border-radius:12px;display:flex;gap:8px;align-items:center;pointer-events:auto;z-index:'+(zBase+100);
    ...
    function make(n){
      ...
      const handle=el.querySelector('.tt');
      function bring(){ el.style.zIndex=++zBase; }
