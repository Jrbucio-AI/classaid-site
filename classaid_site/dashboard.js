...
// Export / Import
function exportAll(){ const data={classes,grades,tasks,quicknotes:notes,settings,sets,version:11}; const blob=new Blob([JSON.stringify(data,null,2)],{type:'application/json'}); const a=Object.assign(document.createElement('a'),{href:URL.createObjectURL(blob),download:'classaid-backup.json'}); a.click(); URL.revokeObjectURL(a.href); }
